...
const STEP_KEYWORDS: { keywords: string[]; label: string; icon: string }[] = [
  { keywords: ["starting", "launching", "bot"], label: "Launching bot on Railway", icon: "ðŸš€" },
  { keywords: ["login", "authenticat", "signing", "keycloak"], label: "Authenticating with DIKSHA", icon: "ðŸ”" },
  { keywords: ["course", "navig", "diksha", "explore", "learning", "listing"], label: "Navigating to course listing", icon: "ðŸŒ" },
  { keywords: ["incomplete", "scanning", "check"], label: "Scanning incomplete modules", icon: "ðŸ”" },
  { keywords: ["playing", "video", "module", "content", "opening"], label: "Playing module content", icon: "â–¶ï¸" },
  { keywords: ["pdf", "document", "reading", "scrolling"], label: "Reading PDF material", icon: "ðŸ“„" },
  { keywords: ["assessment", "quiz", "question"], label: "Completing assessment", icon: "ðŸ“" },
  { keywords: ["completed", "finished", "done", "next module"], label: "Module / Course completed", icon: "âœ…" },
];
...
/* â”€â”€â”€ SVG Icons â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */
const IconGraduate = () => (
...
export default function DikshaAutomationPage() {
  ...
  useEffect(() => {
    ...
    pollRef.current = setInterval(async () => {
      try {
        ...
        // AND the poll returned real course data â€” NEVER wipe existing courses
  ...
  // â”€â”€ Live Screenshot Polling â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  ...
  const currentStepMsg = status?.step || "Idle â€” click 'Scan Enrolled Courses' to begin";
  ...
  const activeTopic = useMemo(() => {
    for (let i = logsList.length - 1; i >= 0; i--) {
      const line = logsList[i];
      if (line.includes("â†’ Opening:") || line.includes("Opening:")) {
  ...
  const topicProgress = useMemo(() => {
    ...
    for (let i = logsList.length - 1; i >= 0; i--) {
      ...
      if (line.includes("[âœ”] Processed") || line.includes("Video done")) return 100;
      if (line.includes("PDF scrolled")) return 90;
      if (line.includes("PDF / Resource Document detected")) return 30;
      if (line.includes("â†’ Opening:")) return 1;
    }
  ...
  const handlePauseToggle = () => {
    ...
    setConfirmModal({
      ...
      confirmText: isCurrentlyPaused ? "â–¶ Resume" : "â¸ Pause",
      cancelText: "Cancel",
      variant: "warning",
  ...
  /* â”€â”€â”€ INITIALIZING AMBIENT SPLASH (Zero Flash on Refresh) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */
  if (isInitializing) {
    return (
  ...
  /* â”€â”€â”€ LOGIN PAGE â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */
  if (stage === "login") {
    return (
      <>
        <style>{`
    ...
    <>
      <style>{`
        ...
        @media (min-width: 641px) {
          ...
          .mobile-email-pill, .mobile-btn { height: 36px !important; min-height: 36px !important; padding: 0 16px !important; font-size: 12px !important; border-radius: 12px !important; box-sizing: border-box !important; display: inline-flex !important; align-items: center !important; justify-content: center !important; }
      ...
      <div className="dash-root" style={{minHeight:'100vh',background:'linear-gradient(135deg, #f8fafc 0%, #f1f5f9 50%, #e2e8f0 100%)',color:'#0f172a',padding:'24px 16px',position:'relative',width:'100%',maxWidth:'100vw',overflowX:'hidden'}}>
        ...
        <div style={{maxWidth:'1200px',margin:'0 auto',position:'relative',zIndex:1,display:'flex',flexDirection:'column',gap:'20px',width:'100%'}}>
            ...
            <div style={{
              ...
              <div style={{display: 'flex', flexDirection: 'column', gap: '2px'}}>
                <span style={{fontSize: '12.5px', fontWeight: '800', color: '#1e293b', display: 'flex', alignItems: 'center', gap: '6px'}}>
                  âš¡ Method 2: API Telemetry Fallback Engine
                </span>
            ...
            <div style={{
              ...
              <div style={{display:'flex',flexDirection:'column',gap:'6px'}}>
                <span style={{fontSize:'12.5px',fontWeight:'800',color:'#15803d',display:'flex',alignItems:'center',gap:'6px'}}>
                  ðŸ¤– MCQ AI Mode â€” Gemini API Key (Optional)
                </span>
          ...
          {/* â”€â”€ STREAMLINED AUTOMATION PROGRESS CARD â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */}
              ...
              <div style={{
                ...
                <div style={{minWidth: 0}}>
                  ...
                  <h4 style={{margin: '2px 0 0', fontSize: '13.5px', fontWeight: '800', color: '#0f172a', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap'}}>
                    {activeTopic ? `â–¶ ${activeTopic}` : "Loading topic / activity..."}
                  </h4>
                </div>
                ...
                <div style={{display:'flex',alignItems:'center',justifyContent:'space-between',marginTop:'4px',paddingTop:'10px',borderTop:'1px solid #cbd5e1',flexWrap:'wrap',gap:'10px'}}>
                  ...
                  <div style={{display:'flex',alignItems:'center',gap:'6px',fontSize:'12px',fontWeight:'800',color:'#475569'}}>
                    <span>ðŸ“Š Overall Progress:</span>
          ...
          {/* â”€â”€ COURSES SECTION â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */}
          <div className="glass-card-light mobile-card" style={{borderRadius:'20px',padding:'28px',width:'100%'}}>
            ...
            <div className="mobile-header-row" style={{display:'flex',flexWrap:'wrap',alignItems:'center',justifyContent:'space-between',gap:'16px',marginBottom:'20px',paddingBottom:'20px',borderBottom:'1px solid #e2e8f0',width:'100%'}}>
              <div>
                ...
                <p style={{margin:0,fontSize:'13px',color:'#64748b',fontWeight:'500'}}>Enrolled courses Â· Progress tracking Â· Automation</p>
              </div>
            ...
            {scanMessage && (
              <div style={{
                ...
                <span>{scanMessage.replace(/^âœ”\s*/, '')}</span>
              </div>
            )}
                  ...
                  return (
                    ...
                    >
                      ...
                      <div style={{height:'120px',background: isCurrent ? 'linear-gradient(135deg,#e0e7ff,#c7d2fe)' : isFinished ? 'linear-gradient(135deg,#d1fae5,#a7f3d0)' : 'linear-gradient(135deg,#f1f5f9,#e2e8f0)',display:'flex',alignItems:'center',justifyContent:'center',position:'relative',borderBottom:'1px solid #e2e8f0',width:'100%'}}>
                        {c.image_url ? (
                          ...
                          <div style={{textAlign:'center'}}>
                            <div style={{width:'48px',height:'48px',borderRadius:'14px',background: isFinished ? '#ecfdf5' : '#e0e7ff',border:`1px solid ${isFinished ? '#6ee7b7' : '#a5b4fc'}`,display:'flex',alignItems:'center',justifyContent:'center',margin:'0 auto 4px',fontSize:'22px'}}>
                              {isFinished ? 'ðŸ†' : isCurrent ? 'â–¶ï¸' : 'ðŸŽ“'}
                            </div>
                        ...
                        {/* Status badge â€” only show for special states (Done / Automating) */}
                        {(isFinished || isCurrent) && (
                          <div style={{position:'absolute',top:'10px',right:'10px'}}>
                            <span style={{
                              ...
                              {isFinished ? <><IconCheck/> 100% Done</> : 'âš¡ Automating'}
                            </span>
                          </div>
                        )}
                      </div>
                        ...
                        <div>
                          ...
                          {c.ends_on && (
                            <p style={{margin:0,fontSize:'11px',color:'#64748b',fontWeight:'600'}}>
                              ðŸ“… Ends: <span style={{color:'#334155'}}>{c.ends_on}</span>
                            </p>
                          )}
                        </div>
          ...
          {/* â•â• MAIN MONITOR CARD â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â• */}
            ...
            <div style={{display:'flex',alignItems:'center',gap:'10px',flexShrink:0}}>
              ...
              {isRunning && (
                <span style={{fontSize:'10px',fontWeight:700,color:'#059669',
                  ...
                  borderRadius:'20px',padding:'2px 10px',letterSpacing:'0.04em'}}>
                  â— RUNNING
                </span>
              )}
            </div>

            {/* 2-COLUMN: FIXED HEIGHT PANELS */}
            <div style={{
              display: 'flex',
              gap: '14px',
              alignItems: 'stretch',
              ...
              {/* â”€â”€ LEFT: LIVE SERVER LOGS â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */}
              <div style={{
                flex: '1 1 400px',
                minWidth: 0,
                height: '420px',
                  ...
                  <div style={{display:'flex',alignItems:'center',gap:'5px',flexShrink:0}}>
                    ...
                    <button onClick={handleCopyLogs} disabled={logsList.length===0}
                      style={{fontSize:'10px',fontWeight:'700',
                        ...
                        background:copiedLogs?'#d1fae5':'#f8fafc',
                        border:`1px solid ${copiedLogs?'#6ee7b7':'#e2e8f0'}`,
                        borderRadius:'6px',padding:'2px 8px',
                        cursor:logsList.length===0?'not-allowed':'pointer',
                        display:'inline-flex',alignItems:'center',gap:'3px',
                        opacity:logsList.length===0?0.5:1}}>
                      {copiedLogs?'âœ“':'ðŸ“‹'} Copy
                    </button>
                    <button onClick={handleClearLogs} disabled={logsList.length===0}
                      style={{fontSize:'10px',fontWeight:'700',
                        color:clearedLogs?'#047857':'#dc2626',
                        background:clearedLogs?'#d1fae5':'#fff5f5',
                        border:`1px solid ${clearedLogs?'#6ee7b7':'#fecaca'}`,
                        borderRadius:'6px',padding:'2px 8px',
                        cursor:logsList.length===0?'not-allowed':'pointer',
                        display:'inline-flex',alignItems:'center',gap:'3px',
                        opacity:logsList.length===0?0.5:1}}>
                      {clearedLogs?'âœ“':'ðŸ—‘'} Clear
                    </button>
                  </div>
                </div>
                ...
                <div ref={logRef} style={{
                  ...
                  {logsList.length === 0 ? (
                    ...
                    logsList.slice(-500).map((line, i) => {
                      const isErr  = line.includes('[ERROR]')||line.includes('[CRITICAL]')||line.includes('âŒ');
                      const isWarn = line.includes('[WARNING]');
                      const isInfo = line.includes('[INFO]')||line.includes('âœ”')||line.includes('100%');
                      return (
              ...
              {/* â”€â”€ RIGHT: LIVE BROWSER VIEW â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */}
              <div style={{
                flex: '1 1 360px',
                minWidth: 0,
                height: '420px',
                ...
                {/* Header â€” same style as left */}
                <div style={{display:'flex',alignItems:'center',justifyContent:'space-between',flexShrink:0}}>
                  <h3 style={{margin:0,fontSize:'12px',fontWeight:'800',color:'#0f172a',
                    textTransform:'uppercase',letterSpacing:'0.07em',
                    display:'flex',alignItems:'center',gap:'7px',whiteSpace:'nowrap'}}>
                    <span style={{fontSize:'13px'}}>ðŸ–¥ï¸</span> Live Browser View
                    <span style={{
                  ...
                  <div style={{display:'flex',alignItems:'center',gap:'5px',flexShrink:0}}>
                    {liveScreenshot && isRunning ? (
                      <span style={{fontSize:'10px',fontWeight:700,color:'#059669',
                        background:'#d1fae5',border:'1px solid #6ee7b7',
                        borderRadius:'20px',padding:'2px 8px',whiteSpace:'nowrap'}}>â— LIVE</span>
                    ) : (
                  ...
                  {liveScreenshot ? (
                    <>
                      ...
                      <div style={{position:'absolute',bottom:6,right:8,
                        ...
                        fontFamily:'JetBrains Mono, monospace'}}>â†» 2s</div>
                    </>
                  ) : (
                    <div style={{textAlign:'center',padding:'30px 16px'}}>
                      <div style={{fontSize:'36px',marginBottom:'10px',opacity:0.15}}>ðŸ–¥ï¸</div>
                      <p style={{color:'#94a3b8',fontSize:'11px',margin:0,
                        fontFamily:'JetBrains Mono, monospace'}}>
                        {isRunning ? 'Waiting for first screenshot...' : 'Start automation to watch live'}
                      </p>
                      {isRunning && (
                        <p style={{color:'#cbd5e1',fontSize:'10px',margin:'6px 0 0',
                          fontFamily:'JetBrains Mono, monospace'}}>
                          Check logs for [LiveView] messages
                        </p>
                      )}
                    </div>
                  )}
          ...
          {/* â•â• END MAIN MONITOR CARD â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â• */}


        </div>
      </div>

      {/* â”€â”€â”€ COURSE DETAILS MODAL â”€â”€â”€ */}
      {showDetailsModal ? (
        <div style={{
                                ...
                                <div style={{
                                  ...
                                  <div style={{
                                    ...
                                    <div style={{display:'flex',alignItems:'center',gap:'12px'}}>
                                      ...
                                      <div>
                                        <p style={{margin:0,fontSize:'13px',fontWeight:'700',color:'#0f172a'}}>{m.name} â€” Reading Material (PDF)</p>
                                  ...
                                  <div style={{
                                    ...
                                    <div style={{display:'flex',alignItems:'center',gap:'12px'}}>
                                      ...
                                      <div>
                                        <p style={{margin:0,fontSize:'13px',fontWeight:'700',color:'#0f172a'}}>{m.name} â€” Interactive Video Lecture</p>
                                  ...
                                  <div style={{
                                    ...
                                    <div style={{display:'flex',alignItems:'center',gap:'12px'}}>
                                      ...
                                      <div>
                                        <p style={{margin:0,fontSize:'13px',fontWeight:'700',color:'#0f172a'}}>{m.name} â€” Assessment & Evaluation</p>
      ...
      {/* â”€â”€â”€ PREMIUM CUSTOM CONFIRMATION DIALOG MODAL â”€â”€â”€ */}
      {confirmModal?.open ? (
        <ConfirmModalDialog
          modal={confirmModal}
